...
@section('container')
        ...
        <div class=" col-md-10 content ">
            <h1 class=" text-white mt-2 ml-2 "> <i class=" fas fa-users   mr-2 mt-3 "></i> DATA SISWA
                ...
                <a class=" btn btn-dark " style=" margin-top: -10px; margin-left:60%; background: #252733; " href="{{ url('/siswa') }}">
            ...
            <hr style=" border: 1px solid white; width: 97%; ">
                ...
                <center>
                <table class=" table table-bordered table-dark" id="datatables" style=" width: 98%; ">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Lengkap</th>
