              ...
              <form class="border p-3 text-white ml-2" action="{{ url('siswa')}}" method="POST">
                  ...
                  <label for="">Jenis Kelamin</label><br>
                    <div class="custom-control custom-radio mb-1">
                      <input type="radio" id="customRadio1" name="jenis_kelamin" class="custom-control-input" value="L" {{old('jenis_kelamin') == 'L' ? 'checked' : ''}}>
                      <label class="custom-control-label" for="customRadio1">L</label>
                    </div>
                    <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="customRadio2" name="jenis_kelamin" class="custom-control-input" value="P" {{old('jenis_kelamin') == 'P' ? 'checked' : ''}}>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control text-secondary" name="golongan_darah" style="background: #252733;">
                        <option value=""   {{ old('golongan_darah') == '' ? 'selected' : '' }}>- Pilih Goldar -</option>
